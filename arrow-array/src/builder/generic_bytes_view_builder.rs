...
///
/// Note: this implementation is performance-sensitive and uses const-generics
/// to generate specialized code for short strings, avoiding a `memcpy` call.
/// See https://github.com/apache/arrow-rs/issues/6034 for more details.
#[inline(always)]
